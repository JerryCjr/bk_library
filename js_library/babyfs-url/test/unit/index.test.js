...
describe('index_test', function () {
  it('anchor_url_should_add_some_parameters_correctly', () => {
    let url = '';
    const ts = +new Date();
    url = urlHelper.addParameter({ ts: ts }, 'http://m.lpt.babyfs.cn/#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978');
    expect(url).to.be.equal(`http://m.lpt.babyfs.cn/?ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);

    url = urlHelper.addParameter({ ts: ts }, 'http://m.lpt.babyfs.cn/page=pageA?id=1#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978');
    expect(url).to.be.equal(`http://m.lpt.babyfs.cn/page=pageA?id=1&ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);
  });

  it('anchor_url_should_remove_some_parameters_correctly', () => {
    let url = '';
    const ts = +new Date();
    url = urlHelper.removeParameter(['ts'], `http://m.lpt.babyfs.cn/?ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);
    expect(url).to.be.equal('http://m.lpt.babyfs.cn/#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978');

    url = urlHelper.removeParameter(['id'], `http://m.lpt.babyfs.cn/page=pageA?id=1&ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);
    expect(url).to.be.equal(`http://m.lpt.babyfs.cn/page=pageA?ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);

    url = urlHelper.removeParameter(['id', 'ts'], `http://m.lpt.babyfs.cn/page=pageA?id=1&ts=${ts}#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978`);
    expect(url).to.be.equal('http://m.lpt.babyfs.cn/page=pageA#/learning_report_v2/preview?readonly=1&course_id=281&lesson_id=1978');
  });
  ...
  it('get_root_domain_should_be_babyfs_cn', () => {
	...
	it('url_should_be_analyzed_correctly', () => {
		let result = urlHelper.analyze('https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2');
		...
		result = urlHelper.analyze('/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2');
		...
		result = urlHelper.analyze('http://139.219.107.152:8888/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2');
		expect(result.isAbsoluteUrl).to.be.true;
		...
		try {
			urlHelper.analyze('https://mp.weixin.qq.com//cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2');
		}
		catch (e) {
			expect(e).to.be.an('error');
			expect(e.message).to.be.equal('url is error');
		...
		result = urlHelper.analyze('https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		expect(result.isAbsoluteUrl).to.be.true;
		expect(result.host).to.be.equal('mp.weixin.qq.com');
		...
		result = urlHelper.analyze('/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		expect(result.isAbsoluteUrl).to.be.false;
		expect(result.host).to.be.equal('');
		expect(result.path).to.be.equal('/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		expect(result.sameDomain).to.be.true;
		...
		result = urlHelper.analyze('http://139.219.107.152:8888/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		expect(result.isAbsoluteUrl).to.be.true;
		expect(result.host).to.be.equal('139.219.107.152:8888');
		expect(result.path).to.be.equal('/cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		expect(result.sameDomain).to.be.false;
		...
		try {
			urlHelper.analyze('https://mp.weixin.qq.com//cgi-bin/announce?action=getannouncement&key=1463324905&version=1&lang=zh_CN&platform=2#title');
		}
		catch (e) {
			expect(e).to.be.an('error');
			expect(e.message).to.be.equal('url is error');
